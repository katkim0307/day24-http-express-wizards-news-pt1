// This module will be responsible for holding all of the posts 
// and giving us functions for interacting with them.
...
const data = [
    {
        ...
        name: "RubeusH",
        date: timeAgo(Date.now() - 15000000)
    },
    {
        id: 2,
        upvotes: 221,
        ...
        name: "Baddock",
        date: timeAgo(Date.now() - 90000000)
    },
    {
        id: 3,
        upvotes: 198,
...
// You now have a data array with all the posts, 
// but we do not want to make this array directly accessible to the rest of our app; 
// it will safely remain as a private variable inside the postBank module.
// What we will make available, using module.exports, are functions for listing and finding posts.

const list = () => {
    return [...data]
    // Notice that we're returning a copy of the array, 
    // so the original data is safe. This is called 'immutability'.
}
